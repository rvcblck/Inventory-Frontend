...
@Component({
  selector: 'app-requestor-layout',
  templateUrl: './requestor-layout.component.html',
  styleUrls: ['./requestor-layout.component.css']
})
export class RequestorLayoutComponent implements OnInit {
